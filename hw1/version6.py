...
def debug(dataidx):
    data= pd.read_csv('example_with_answer.csv',header=None,names=['index','sentence','subject','verb','object'])
    
    sen = data['sentence'][dataidx]
    print("**********************************************************************************")
    print('sentence: ', sen)
    print("**********************************************************************************")
    doc = nlp(sen)
    ...
    a = word_in_sen(s, str(data["subject"][dataidx]))
    b = word_in_sen(v, str(data["verb"][dataidx]))
    c = word_in_sen(o, str(data["object"][dataidx]))
